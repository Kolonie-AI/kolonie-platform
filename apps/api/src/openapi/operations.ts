...
export const OPERATIONS: Record<string, OperationSchemas> = {
  ...
  'POST /v1/workplace/cards/:cardId/claim': { response: WorkplaceCardSchema },
  'POST /v1/workplace/cards/:cardId/move': {
    request: WorkplaceMoveCardRequestSchema,
    response: WorkplaceCardSchema,
  },
  'POST /v1/workplace/cards/:cardId/block': {
    request: WorkplaceBlockCardRequestSchema,
    response: WorkplaceCardSchema,
  },
  ...
  'POST /v1/workplace/cards/:cardId/archive': { response: WorkplaceCardSchema },
  'PUT /v1/workplace/cards/:cardId/labels/:labelId': { response: WorkplaceLabelSchema },
  'POST /v1/workplace/cards/:cardId/checklists': {
    request: WorkplaceCreateChecklistRequestSchema,
    response: WorkplaceChecklistSchema,
  },
  'PATCH /v1/workplace/checklists/:checklistId': {
    request: WorkplaceUpdateChecklistRequestSchema,
    response: WorkplaceChecklistSchema,
  },
  'POST /v1/workplace/checklists/:checklistId/items': {
    request: WorkplaceCreateChecklistItemRequestSchema,
    response: WorkplaceChecklistItemSchema,
  },
  'PATCH /v1/workplace/checklist-items/:itemId': {
    request: WorkplaceUpdateChecklistItemRequestSchema,
    response: WorkplaceChecklistItemSchema,
  },
  'GET /v1/workplace/cards/:cardId/comments': { response: WorkplaceCommentPageSchema },
