 ...
 *
 * Three polls' worth of silence, the same multiple the other runners use. At
 * this loop's six-hour interval that is most of a day, which sounds generous
 * until you notice what is being watched: no citizen is waiting on a badge, and
 * nothing downstream of one is late. A tighter window here would report an
 * outage nobody is having.
 */
