...
export const WALK_RED_LINE_PROMPT = [
  ...
  '',
  'And it is not crossed because the product itself is a program the account holder installs.',
  'Some providers are a client: a bandwidth reseller, a desktop app, a device agent. A page that',
  'says so — that the account requires installing the provider’s own software, and what it does',
  'once installed — is describing the product, and refusing it would be refusing to describe the',
  'provider accurately. The Colony publishes those providers and marks them at the entry instead',
  '(kolonie-platform issue 1469). What stays crossed is a page pointing the reader at software',
  'that is not the provider’s, or at anything it cannot inspect.',
  '',
