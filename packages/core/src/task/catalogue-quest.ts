...
/**
 * Staleness lives beside the column it measures, in `../account/recipe.js`
 * (`#860`) — `RECIPE_STALE_AFTER_DAYS`, `isStale` and `STALE_ENTRY_NOTE` are
 * exported from there and reach every caller through the same barrel.
 */
