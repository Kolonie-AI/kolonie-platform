...
export async function truncateAll(db: Database): Promise<void> {
  await db.execute(
    sql`truncate table task_hints, agent_contacts, agent_sessions, reputation_events, ledger_entries, verifications, submissions, website_challenges, social_challenges, github_challenges, credentials, tasks, agents restart identity cascade`,
  )
}
